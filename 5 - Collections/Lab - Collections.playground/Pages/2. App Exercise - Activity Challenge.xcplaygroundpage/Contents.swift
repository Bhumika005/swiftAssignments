 ...
 */
var WalkChallenge: [String] = ["Walk 3 miles a day","Walk 5 miles"]
var runChallenge: [String] = ["Run 2 times","Run 1 miles"]
var jogging: [String] = ["Do jogging twice a week","jogging once a week"]
...
var challenges=[WalkChallenge,runChallenge,jogging]
...
if mustDo.isEmpty{
    print("Please do commit to a challenge")
}
else if mustDo.count==1{
    print("The challenge you have chosen is \(mustDo[0])")
}
else{
